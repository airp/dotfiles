...
'./S/server/permanent',
'-I',
'./S/server/water/libs/google_protobuf/installed/include',
'-I',
'./S/server/water/libs/websocketpp/websocketpp',
'-I',
'./S/server/water/libs/mysql++/installed/include',
'-I',
'./S/server/water/libs/hiredis/installed/include',
]
